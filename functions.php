...
function my_enqueue_assets() { 
  $node_modules_path = get_stylesheet_directory_uri() . '/node_modules/';
	wp_enqueue_style( 'google_fonts', 'https://fonts.googleapis.com/css2?family=Lato:wght@700&family=Nunito&family=Roboto+Slab:wght@700&display=swap');
  wp_enqueue_style( 'parent-style', get_template_directory_uri().'/style.css' ); 
    
  wp_register_script('single_product', get_stylesheet_directory_uri() . '/js/single-product.js', array('jquery'), '', true);
